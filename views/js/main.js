...
uilt into the code, you'll find a few instances of the User Timing API
...
var resizePizzas = function (size) {
    ...
    function changePizzaSizes(size) {
        ...
        var pizzacount = container.length;
...
function updatePositions() {
    ...
    // Outside the for statement/loop I declare the variable phase
    var phase;
